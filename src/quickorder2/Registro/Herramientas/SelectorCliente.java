...
import quickorder2.Registro.Herramientas.ListRenderers.ClienteListCellRenderer;
...
public class SelectorCliente extends javax.swing.JDialog {
    ...
    public SelectorCliente(java.awt.Frame parent, JInternalFrame par) {
        super(parent, true);
        initComponents();
        this.par = par;
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SelectorCliente dialog = new SelectorCliente(new javax.swing.JFrame(), null);
