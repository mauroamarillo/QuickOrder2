 ...
 * @author Mauro
 */
public class DetalleCliente extends javax.swing.JDialog {
    ...
    private void cargarDatos(String nick){
        webservices.DataCliente cliente = quickorder2.QuickOrder2.port.buscarCliente(nick);
        lblNombre.setText(cliente.getNombre());
        lblApellido.setText(cliente.getApellido());
        lblFN.setText(String.format("%02d/%02d/%d", cliente.getFechaNac().getDia(), cliente.getFechaNac().getMes(), cliente.getFechaNac().getAgno()));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DetalleCliente dialog = new DetalleCliente(new javax.swing.JFrame(), "");
